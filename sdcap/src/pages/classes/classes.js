...
<section id="mainText">
            <div id="container">
                ...
                <div id="scheduleTuition">
                    ...
                    <article id="tuition">
                        <h2>Tuition</h2>
                        <h3>2021 Annual Registration Fee $25 - WAIVED</h3>
                        <p>
                        ...
                        <p>
                            <h4>MUSICAL THEATRE PRODUCTION CLASS</h4>
                        ...
                        <p>
                            <h4>Private Coaching & Choreography:<br /> ACTING, DANCE, PUBLIC SPEAKING, AUDITION PREP & PERSONAL FITNESS</h4>
                ...
                <article id="camps">
                    ...
                    <header>
                        <h1>Camps:</h1><br />
                        <h4>Camps are currently via Zoom. Camps will be in person when SD Country Guidlines permit. Stay tuned.<br /> Stay Safe San Diego!</h4>
                        <br />
                        <div id="campTuition">
                            <h4>CAMPS for Youth Ages 4-17</h4>

                            <p>Musical Theatre, Dance, Acting, Singing</p>

                            <h4><strong>ALL CAMPS</strong> are <strong>10:00am - 1:00pm</strong>, tuition $100.</h4>
                        ...
                        <div id="campInfo">
                            ...
                            <p><span class="campDateRange">JUNE 14 - 18:</span> <a href="#fun">FUN!</a> Dance, Act & Sing ~ ages 4-8</p>
                            <p><span class="campDateRange">JUNE 21 - 25:</span> <a href="#broadwayBound">BROADWAY
                                    BOUND!</a> ﻿~ ages 7-17</p>
                            <h4>JULY</h4>


                            <p><span class="campDateRange">JULY 5-9:</span> <a href="#lightsCameraAction">CAMERA
                                    READY!</a> #1 ~ ages 7-17 ﻿</p>

                            <p><span class="campDateRange">JULY 12 - 16:</span> <a href="#danceAllDay">DANCE ALL DAY</a> ~ ages 10 -17 </p>

                            <p><span class="campDateRange">JULY 19 - 23:</span> <a href="#fun">FUN!</a> Dance & Sing Camp ~ ages 4-8</p>

                            <p><span class="campDateRange">JULY 26 - 30:</span> <a href="#tripleThreatTap">TRIPLE THREAT
                                    +
                                    TAP!</a> ~ ages 7-17 </p>

                            <h4>AUGUST</h4>

                            <p><span class="campDateRange">AUGUST 2 -6 :</span><a href="#lightsCameraAction">CAMERA
                                    READY!</a> #2 ~ ages 7-17 </p>
                            <p><span class="campDateRange">AUGUST 9 - 13:</span> <a href="#broadwayBound">BROADWAY
                                    BOUND!</a> ~ ages 7-17 </p>
                            <p><span class="campDateRange">AUGUST 16 - 20:</span> <a href="#fun">FUN!</a> Dance, Act & Sing ~ ages 4-8</p>
                ...
                <article id="descriptions">
                    ...
                    <div id="twoDescriptions">
                        ...
                        <div id="classDescriptions">
                            <h2>Classes:</h2>
                            <a class="anchor" id="preDance"></a>

                            <a class="anchor" id="funDance"></a>

                            <a class="anchor" id="kids1Dance"></a>

                            <img id="ballerina" src="./assets/images/cyanBallerina.png" alt="blue Shillouette of kid in ballet pose" />

                            <a class="anchor" id="actingUpK-2"></a>
                            <a class="anchor" id="musicalTheater1-5"></a>

                            <div class="courseInfo">
                                <h4><strong>Pre Dance Grade Levels : TK-K</strong></h4>

                                Introduction to dance, how to be in a class, Very creative Ballet & Tap
                            </div>
                            <a class="anchor" id="tumbling"></a>

                            <a class="anchor" id="kids2Ballet"></a>

                            <div class="courseInfo">
                                <h4><strong>FUN! - Dance for Beginners Grade Levels TK-2</strong></h4>
                            ...
                            <div class="courseInfo">
                                <h4><strong>Kids 1 Dance Grade Levels K-2</strong></h4>
                            ...
                            <div class="courseInfo">
                                <h4><strong>Acting Up - Kids 1 Grade Levels : K-2</strong></h4>

                                Introduction to Theatre - Fun acting games, exercises, and scene work, students will perform a story.
                            </div>

                            <a class="anchor" id="kids2TapJazz"></a>

                            <div class="courseInfo">
                                <h4><strong>Musical Theatre Production- Kids Grade Levels : 1-5</strong></h4>
                            ...
                            <a class="anchor" id="actingUp3-5"></a>

                            <div class="courseInfo">
                                <h4><strong>Tumbling Grade Levels : 1- 5</strong></h4>

                                Beginner Tumbling moves to improve strength and flexibility Half hour class
                            </div>

                            <a class="anchor" id="kids3Ballet"></a>

                            <div class="courseInfo">
                                <h4><strong>Kids 2 Ballet Grade Levels : 3-5</strong></h4>

                                Students will advance and learn new dance technique and vocabulary
                            </div>

                            <a class="anchor" id="kids3TapJazz"></a>

                            <div class="courseInfo">
                                <h4><strong>Kids 2 Tap & Jazz Grade Levels: 3-5</strong></h4>

                                Students will learn Musical Theatre style Tap & Jazz dance
                            </div>

                            <a class="anchor" id="actingUp6-12"></a>

                            <div class="courseInfo">
                                <h4><strong>Acting Up - Kids 2 Grade Levels : 3-5</strong></h4>
                            ...
                            <br />
                            <img id="ballerina" src="./assets/images/redDancer.png" alt="red Shillouette of person posing" />

                            <a class="anchor" id="musicalTheater6-12"></a>

                            <div class="courseInfo">
                                <h4><strong>Kids 3 Ballet Grade Levels : 6- 8</strong></h4>
                            ...
                            <div class="courseInfo">
                                <h4><strong>Kids 3 Tap & Jazz Grade Levels : 6- 8</strong></h4>

                                Description : Students will dazzle with impressive Tap & Jazz steps and choreography
                            </div>

                            <a class="anchor" id="contemporaryDance"></a>

                            <div class="courseInfo">
                                <h4><strong>Acting Up - Youth/Teens Grade Levels : 6- 12</strong></h4>
                            ...
                            <a class="anchor" id="pilatesMat"></a>

                            <div class="courseInfo">
                                <h4><strong>Musical Theatre Production - Youth Grade Levels : 6-12</strong></h4>
                            ...
                            <div class="courseInfo">
                                <h4><strong>Ballet Teen/Adult</strong></h4>
                            ...
                            <div class="courseInfo">
                                <h4><strong>Contemporary Dance Teen/Adult</strong></h4>
                            ...
                            <div class="courseInfo">
                                <h4><strong>Pilates Mat Class: Teen - Adult</strong></h4>
                        ...
                        <div id="campDescriptions">
                            ...
                            <br />
                            <p class="campDate">Each camp does a final day performance!</p>
                            <p class="campDate">Invite friends and family to watch on Zoom!</p>

                            <br />

                            <a class="anchor" id="fun"></a>

                            <img src="./assets/images/orangeJump.png" alt="orange Shillouette of kid jumping" />

                            <div class="courseInfo">
                                <h4><strong>FUN! Dance & Sing Camp ages 4-7</strong></h4>

                                <h5 class="campDate">JUNE 14 - 18</h5>

                                <h5 class="campDate">JULY 19 - 23</h5>

                                <h5 class="campDate">AUGUST 16 - 20</h5>
                            ...
                            <a id="danceAllDay" class="anchor"></a>

                            <img src="./assets/images/pinkJump.png" alt="pink Shillouette of kid jumping" />

                            <div class="courseInfo">
                                <h4><strong>Dance All Day ages 10-17</strong></h4>

                                <h5 class="campDate">JULY 12 - 16</h5>
                            ...
                            <img src="./assets/images/greenJump.png" alt="green Shillouette of kid jumping" />

                            <a id="broadwayBound" class="anchor"></a>
                            <div class="courseInfo">
                                <h3><strong>MUSICAL THEATRE KIDS</strong></h3>
                                <h5 class="campDate">ages 7-17</h5>
                                ...
                                <a id="tripleThreatTap" class="anchor"></a>

                                <h4><strong>BROADWAY BOUND!</strong></h4>
                                    <h5 class="campDate">JUNE 21 - 25</h5>
                                    <h5 class="campDate">AUGUST 9 - 13</h5>
