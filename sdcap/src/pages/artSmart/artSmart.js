            ...
            <section id="mainText">
                <div id="container">
                    <header>
                        ...
                        <img id="jumpingKids" src="./assets/images/artSmart/jump.jpeg
                        " alt="kids in the studio jumping"></img>
                        <div id="about">
                            ...
                            <img src="./assets/images/artSmart/pexels-pragyan-bezbaruah-1720186.jpg" alt="two students at a table doing art with pastels and pencils"></img>
                            <h1 id="coursesH1">Available courses</h1>

                            <div class="courses">
                                <h3 class="title">Fun Dance - Basic <span class="carat">▾</span></h3>
                                <p class="desc closed">
                            ...
                            <div class='courses'>
                                <h3 class='title'>Hip Hop <span class="carat">▾</span></h3>
                                <p class='desc closed'>
                            ...
                            <div class='courses'>
                                <h3 class='title'>Social Dance <span class="carat">▾</span></h3>
                                <p class='desc closed'>
                            ...
                            <div class='courses'>
                                <h3 class='title'>Theater <span class="carat">▾</span></h3>
                                <p class='desc closed'>
                            ...
                            <div class='courses'>
                                <h3 class='title'>Spoken Word Poetry <span class="carat">▾</span></h3>
                                <p class='desc closed'>
                            ...
                            <div class='courses'>
                                <h3 class='title'>Voice & Music Theory <span class="carat">▾</span></h3>
                                <p class='desc closed'>
                            ...
                            <div class='courses'>
                                <h3 class='title'>Visual Art <span class="carat">▾</span></h3>
                                <p class='desc closed'>
                            ...
                            <div class='courses'>
                                <h3 class='title'>Yoga <span class="carat">▾</span></h3>
                                <p class='desc closed'>
                            ...
                            <div class='courses'>
                                <h3 class='title'>Arts Integration Courses <span class="carat">▾</span></h3>
                                <div class='desc closed'>
                            ...
                            <div class='courses'>
                                <h3 class='title'>Musical Theatre Play Production <span class="carat">▾</span></h3>
                                <div class='desc closed'>
                            ...
                            <p><a href="./assets/images/artSmart/The  SDCAP Arts Smart Program.pdf">further artSmart information</a></p>
                        </div>
                    </header>
